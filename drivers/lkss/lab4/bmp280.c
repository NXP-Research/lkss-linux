				  ...
				  s32 *t_fine)
{
	 ...
	 */
	(void)var1; (void)var2; (void)adc_T;
	*t_fine = 0;
	return 0; /* replace me */
}
				   ...
				   s32 t_fine)
{
	...
	/* Transcribe the 8-step 64-bit formula from the Theory section here.
	 * Don't forget the divide-by-zero guard after computing var1.        */
	(void)var1; (void)var2; (void)p; (void)adc_P; (void)t_fine; (void)c;
	return 0; /* replace me */
}
				...
				struct device_attribute *attr, char *buf)
{
	...
	struct bmp280_data *data = NULL; /* replace me */
	s32 temp; u32 praw;
	int ret;
...
static int bmp280_probe(struct i2c_client *client)
{
	 ...
	 * sysfs_create_group(&client->dev.kobj, &bmp280_group) here instead. */
